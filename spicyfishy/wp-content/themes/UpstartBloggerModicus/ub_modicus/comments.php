...
<?php if ($comments) : ?>
<p><b>COMMENTS</b> / <?php comments_number('BE THE FIRST TO COMMENT', 'ONE COMMENT', '% COMMENTS' );?></p>
...
<?php if ('open' == $post->comment_status) : ?>
<p id="respond"><b>SPEAK</b> / ADD YOUR COMMENT<br/>
	<strong>Comments are moderated.</strong>
</p>
