...
<?php if ($comments) : ?>
<p class="commentheader" id="comments"><?php comments_number(__('No Responses'), __('One Response'), __('% Responses') );?> <?php _e('to'); ?> &#8220;<?php the_title(); ?>&#8221;</p> 
...
<?php endif; ?>
<br />
<a class="commentlink" href="#comment-<?php comment_ID() ?>" title=""><?php comment_date('j. F Y') ?> at <?php comment_time('H:i') ?></a> <?php edit_comment_link('(#)','',''); ?>
<br class="clear" />
<?php comment_text() ?>
</li>
...
<?php endif; ?>
<?php if ('open' == $post-> comment_status) : ?>
<p class="commentheader" id="respond"><?php _e('Leave a Reply'); ?></p>
<?php if ( get_option('comment_registration') && !$user_ID ) : ?>
<p><?php _e('You must be logged in to post a comment.'); ?></p>
<?php else : ?>
