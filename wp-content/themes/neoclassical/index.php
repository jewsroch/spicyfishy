...
<?php the_content('[Read more &rarr;]'); ?>
					...
					<p class="to_comments"><span class="date"><?php the_time('F j, Y') ?></span> &nbsp; <span class="num_comments"><?php comments_popup_link('No Comments', '1 Comment', '% Comments'); ?></span>  <--Click to Leave one! </p>
...
<script type="text/javascript">
try {
var pageTracker = _gat._getTracker("UA-6784373-1");
