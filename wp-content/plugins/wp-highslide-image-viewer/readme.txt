...
Note, as of version 1.23, WP-Highslide is compatible up to wordpress version 2.3.X
...
1. Expanded image using highslide wordpress plugin

== Demo ==
See an example of this plugin  in this [Wedding Cake Gallery](http://blog.pinkcakebox.com/category/pastry-images/wedding-cakes/ "Wedding Gallery")
