...
Tags: widget, admin, links, frontend
...
1. **Frontend:** This is what the widget looks like when you're logged in as admin.
2. **Backend:** You can select which links you want displayed. No links are displayed unless their relevant to the currently logged in user, on the page they're currently viewing.