...
function get_photoshop_file_info( $Exif_array, $XMP_array, $IRB_array )
{
        ...
        if ( $dublincore_block != FALSE )
        {
                ...
                if ( $Item != FALSE )
                {
                        ...
                        {
                                $outputarray = add_to_field( $outputarray, 'caption' , $Item['children'][0]['children'][0]['value'], "\n" );
                        }
                }
                ...
                if ( $Item != FALSE )
                {
                              ...
                              ( array_key_exists( 'value', $Item['children'][0]['children'][0] ) ) )
                        {
                                ...
                                $outputarray = add_to_field( $outputarray, 'title' , $Item['children'][0]['children'][0]['value'], "," );
                        }
                }
                ...
                if ( $Item != FALSE )
                {
                        ...
                        if  ( ( array_key_exists( 'children', $Item ) ) && ( $Item['children'][0]['tag'] =="rdf:Bag" ) && is_array($Item['children'][0]['children']))
                        {
        ...
        if ( $IRB_array != FALSE )
        {
                ...
                if ( ( $IPTC_array != FALSE ) && ( count( $IPTC_array ) != 0 ) )
                {
                        ...
                        $record = empty($outputarray["caption"]) ? find_IPTC_Resource( $IPTC_array, "2:120" ) : false;
        ...
        if ( ( $Exif_array != FALSE ) || ( count( $Exif_array ) == 0 ) )
        {
                ...
                if ( @array_key_exists( 270, $Exif_array[0] ) && empty($outputarray["caption"]))
                {
                ...
                // Check the Date and Time tag - it contains the date
                if ( @array_key_exists( 306, $Exif_array[0] ) )
                {
                		$dt = explode(" ", $Exif_array[0][306]['Data'][0]);
                        $outputarray = add_to_field( $outputarray, 'date' , HTML_UTF8_UnEscape( str_replace(":","-", $dt[0]) ), "\n" );
                }
...
function put_photoshop_file_info( $jpeg_header_data, $new_ps_file_info_array, $Old_Exif_array, $Old_XMP_array, $Old_IRB_array )
{
        ...
        {
                // INVALID DATE
                echo "Invalid Date: $new_ps_file_info_array[date] - must be YYYY-MM-DD format<br>";
                return FALSE;
        }
        ...
        $new_Exif_array[0][270] = array (       "Tag Name"   => $GLOBALS[ "IFD_Tag_Definitions" ]['TIFF'][ 270 ]['Name'],
                                                ...
                                                "Data"       => array( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'caption' ]) ));
        ...
        $new_Exif_array[0][315] = array (       "Tag Name"   => $GLOBALS[ "IFD_Tag_Definitions" ]['TIFF'][ 315 ]['Name'],
                                                ...
                                                "Data"       => array( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'author' ] ) ) );
        ...
        $new_Exif_array[0][33432] = array (     "Tag Name"   => $GLOBALS[ "IFD_Tag_Definitions" ]['TIFF'][ 33432 ]['Name'],
                                                ...
                                                "Data"       => array( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'copyrightnotice' ]) ) );
        ...
        $new_IPTC_array = array (
                                  ...
                                  array (
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'caption' ] ), 0 , 2000 ),
                                  ),
                                  2 =>
                                  array (
                                    'IPTC_Type' => '2:122',
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'captionwriter' ] ), 0 , 32 ),
                                  ),
                                  3 =>
                                  array (
                                    'IPTC_Type' => '2:105',
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'headline' ] ), 0 , 256 ),
                                  ),
                                  4 =>
                                  array (
                                    'IPTC_Type' => '2:40',
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'instructions' ] ), 0, 256 ),
                                  ),
                                  5 =>
                                  array (
                                    'IPTC_Type' => '2:80',
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'author' ] ), 0, 32 ),
                                  ),
                                  6 =>
                                  array (
                                    'IPTC_Type' => '2:85',
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'authorsposition' ] ), 0, 32 ),
                                  ),
                                  7 =>
                                  array (
                                    'IPTC_Type' => '2:110',
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'credit' ] ), 0, 32 ),
                                  ),
                                  8 =>
                                  array (
                                    'IPTC_Type' => '2:115',
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'source' ] ), 0, 32 ),
                                  ),
                                  9 =>
                                  array (
                                    'IPTC_Type' => '2:05',
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'title' ] ), 0, 64 ),
                                  ),
                                  10 =>
                                  array (
                                    'IPTC_Type' => '2:55',
                                  ...
                                  array (
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'city' ] ), 0, 32 ),
                                  ),
                                  12 =>
                                  array (
                                    'IPTC_Type' => '2:95',
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'state' ] ), 0, 32 ),
                                  ),
                                  13 =>
                                  array (
                                    'IPTC_Type' => '2:101',
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'country' ] ), 0, 64 ),
                                  ),
                                  14 =>
                                  array (
                                    'IPTC_Type' => '2:103',
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'transmissionreference' ] ), 0, 32 ),
                                  ),
                                  15 =>
                                  array (
                                    'IPTC_Type' => '2:15',
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'category' ] ), 0, 3 ),
                                  ),
                                  21 =>
                                  array (
                                    'IPTC_Type' => '2:116',
                                    ...
                                    'RecData' => substr( HTML_UTF8_UnEscape( $new_ps_file_info_array[ 'copyrightnotice' ] ), 0, 128 ),
                                  ),
                                );
